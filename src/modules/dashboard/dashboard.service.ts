import { PropertyType, DealType, SellerType, JobStatus, RealEstateStatus } from '@prisma/client';
...
export class DashboardService {
    ...
    async fetchExchangeRates(): Promise<{
        ...
        try {
            ...
            console.error(error);
            throw new InternalServerErrorException('Exchange rates fetch failed');
        }
    }
