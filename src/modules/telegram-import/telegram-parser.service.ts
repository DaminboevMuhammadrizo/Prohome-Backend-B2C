...
export class TelegramParserService {
  ...
  parse(rawText: string): ParsedListing {
    ...
    // Bino maydoni (m²) — "60 m2" yoki "Майдони - 69.65"
    ...
    return { title, originalId, price, roomCount, areaSize, plotSize, floor, dealType, propertyType, contactPhone, addressCandidate, district, landmark, missingFields };
  }
